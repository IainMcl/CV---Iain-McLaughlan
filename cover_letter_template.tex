...
% Photo currently in circle in top left
\photo[circle,edge,left]{ps}
% my name
\name{Iain}{McLaughlan}
% Roles currently as a list of hyperlinks
\position{
    \href{https://publichealthscotland.scot/}{Public Health Scotland}{\enskip\cdotp\enskip}
...
% ------------------------------------------------------------------------------------------------------------------------------------------------
% TO BE COMPLETED PER APPLICATION
% ------------------------------------------------------------------------------------------------------------------------------------------------
\recipient
  % Company name
  {Healios}
  % Company address
  % Think about page layout in how this is formatted
